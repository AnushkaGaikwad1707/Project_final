  ...
  return (
    <div className="page-overview">
      <PageHeader 
        ...
        subtitle="Holdout Split LOTSPLIT-05 · 1,343 Components across 18 Production Lots · Authoritative Benchmark"
      >
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi-card pass">
          ...
          <div className="kpi-sub">
            <strong>{((summary?.pass_count / summary?.total) * 100).toFixed(1)}%</strong> of fleet compliant
          </div>
          <div className="kpi-bar-track">
        ...
        <div className="kpi-card reject">
          ...
          <div className="kpi-sub">
            <strong>23</strong> Confirmed Failures + <strong>5</strong> Forecast Breaches
          </div>
          <div className="kpi-bar-track">
      ...
      <div className="modules-overview-grid">
        ...
        <Card title="Module A: Static Screening (168h)" className="summary-module-card">
          <div className="module-summary-body">
            ...
            <div className="module-stat-row">
              ...
              <span className="stat-val code-font">0.900 (1% FPR Budget)</span>
            </div>
            <div className="module-stat-row">
        ...
        <Card title="Module B: 168h Prognosis (0–24h Input)" className="summary-module-card">
          <div className="module-summary-body">
            ...
            <div className="module-stat-row">
              ...
              <span className="stat-val text-reject font-bold">5 parts (Limit exceeded)</span>
            </div>
        ...
        <Card title="Model Performance (Holdout 168h)" className="summary-module-card">
          <div className="module-summary-body">
            <div className="eval-mini-grid">
              ...
              <div className="eval-mini-box">
                <span className="eval-mini-label">FPR BUDGET</span>
            ...
            <div className="decision-callout">
              ...
              <p className="decision-text">
                Operating at 1% FPR budget ({baseline.fp || 13} FP / {baseline.fn || 25} FN). Relaxing to catch 1 more defect ({baseline.fn ? baseline.fn - 1 : 24} FN) incurs +5 false alarms with only +0.12% F2 gain.
              </p>
            </div>
          </div>
        </Card>
